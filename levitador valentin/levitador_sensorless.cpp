...
// Flag para cambiar entre modo monitoreo (0) y sensorless (1)
int USE_OBSERVER_FOR_CONTROL = 0;  // 0=SENSOR (monitoreo), 1=OBSERVADOR (sensorless)
				...
				if(flagcom==5)
   				{
    				...
    				// Seleccionar realimentación: sensor (monitoreo) u observador (sensorless)
    				float y_feedback = USE_OBSERVER_FOR_CONTROL ? y_obs : y;
    				
    				// NOTA: El PID ya fue calculado arriba con 'y' (sensor)
    				// Para modo sensorless, necesitaríamos recalcular el PID con y_feedback
    				// Por ahora, el observador corre en paralelo para validación
